...
class PhotoEssayTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.essay = PhotoEssay.objects.create(
            title="Test Essay", description="A test photo essay", is_published=True
        )
    ...
    def test_featured_essays_query(self):
        ...
        featured_essay = PhotoEssay.objects.create(
            title="Featured Essay", is_published=True, is_featured=True
        )
        unfeatured_essay = PhotoEssay.objects.create(
            title="Regular Essay", is_published=True, is_featured=False
        )
...
class PhotoTestCase(TestCase):
    ...
    def setUp(self):
        """Create test data."""
        self.essay = PhotoEssay.objects.create(title="Test Essay", is_published=True)

    def test_photo_with_local_image_url(self):
        """Test that photo can use local image URL."""
        photo = Photo.objects.create(title="Local Photo", image="test_image.jpg")
    ...
    def test_photo_with_external_url(self):
        ...
        photo = Photo.objects.create(title="External Photo", external_url=external_url)
        PhotoEssayPhoto.objects.create(essay=self.essay, photo=photo)
    ...
    def test_external_url_preferred_over_local(self):
        ...
        photo = Photo.objects.create(
            title="Both Photos", image="test_image.jpg", external_url=external_url
        )
        PhotoEssayPhoto.objects.create(essay=self.essay, photo=photo)
        self.assertEqual(photo.get_image_url(), external_url)
    ...
    def test_photo_without_image_fails_validation(self):
        ...
        photo = Photo(title="No Image Photo")
    ...
    def test_photo_display_order(self):
        ...
        photo1 = Photo.objects.create(
            title="First Photo", external_url="https://example.com/1.jpg"
        )
        photo2 = Photo.objects.create(
            title="Second Photo", external_url="https://example.com/2.jpg"
        )
        ...
        links = PhotoEssayPhoto.objects.filter(essay=self.essay).order_by(
            "display_order"
        )
    ...
    def test_standalone_photo(self):
        ...
        photo = Photo.objects.create(
            title="Standalone Photo", external_url="https://example.com/standalone.jpg"
        )
...
class PhotographyViewsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.unpublished_essay = PhotoEssay.objects.create(
            title="Unpublished Essay", is_published=False, is_featured=True
        )
    ...
    def test_photo_list_view(self):
        ...
        standalone_photo = Photo.objects.create(
            title="Standalone", external_url="https://example.com/photo.jpg"
        )
    ...
    def test_photo_detail_view(self):
        ...
        photo = Photo.objects.create(
            title="Detail Photo", external_url="https://example.com/detail.jpg"
        )
        response = self.client.get(reverse("photography:photo_detail", args=[photo.pk]))
        self.assertEqual(response.status_code, 200)
...
class GalleryViewsTestCase(TestCase):
    ...
    def test_gallery_access_with_password(self):
        access_url = reverse(
            "photography:gallery_access", args=[self.private_gallery.slug]
        )
        response = self.client.post(access_url, {"password": "secret"})
        self.assertEqual(response.status_code, 302)

        detail_url = reverse(
            "photography:gallery_detail", args=[self.private_gallery.slug]
        )
    ...
    def test_gallery_toggle_favorite(self):
        detail_url = reverse(
            "photography:gallery_detail", args=[self.public_gallery.slug]
        )
