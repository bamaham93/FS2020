...
urlpatterns = [
    ...
    path("prayer-requests/delete/<int:id>", views.delete_prayer_request, name="delete_prayer_request"),
    path("prayer-requests/mark-important/<int:id>", views.toggle_important, name="toggle_important"),
    path("prayer-requests/mark-complete/<int:id>", views.toggle_complete, name="toggle_complete"),
    path("prayer-requests/answer/<int:id>", views.answer_prayer_request, name="answer_prayer_request"),
