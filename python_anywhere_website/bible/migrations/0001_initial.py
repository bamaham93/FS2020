        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Book name (e.g., 'John')", max_length=50
                    ),
                ),
                (
                    "slug",
                    models.SlugField(
                        help_text="URL-friendly name (e.g., 'john')", unique=True
                    ),
                ),
                (
                    "order",
                    models.PositiveIntegerField(
                        help_text="Book order (1-66)", unique=True
                    ),
                ),
                (
                    "testament",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["book", "chapter"],
                        name="bible_bible_book_id_287370_idx",
                    )
                ],
